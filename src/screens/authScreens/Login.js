...
import {Call_GetListServices, Call_PostServices} from '../../Services/Services';
import {GetData, Login_API} from '../../config/Url';
...
const Login = () => {
  ...
  const getUserData= async()=>{
    const res= await Call_GetListServices(GetData)
    console.log(res)
  }
